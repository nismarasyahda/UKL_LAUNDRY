        ...
        <tbody>
            ...
            while($data_member=mysqli_fetch_array($qry_member)){
                ...
                <tr>              
                    ...
                    <a style="margin-left:10px;" href="hapus_member.php?id=<?=$data_member['id']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td> 
                </tr>
                <?php 
            }
            ?>
