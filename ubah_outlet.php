...
<body>
    <?php 
    include "koneksi.php";
    $qry_get_user=mysqli_query($conn,"select * from outlet where id = '".$_GET['id']."'");
    ...
    <form action="proses_ubah_outlet.php" method="post">
        ...
        Alamat :
        <input type="varchar" name="alamat" value=   "<?=$dt_user['alamat']?>" class="form-control">
        Tlp :
        <input type="int" name="tlp" value=    "<?=$dt_user['tlp']?>" class="form-control">
